...
(function() {
      ...
      // Delete column
      {
        ...
        formatter: function(cell) {
          ...
          if (data._isNew) {
            ...
            confirmBtn.className = "strat-confirm-btn";
            ...
            cancelBtn.className = "strat-cancel-btn";
  ...
  function initGrid(containerDiv) {
    ...
    addBtn.addEventListener("click", function() {
      table.addRow(
        { _isNew: true, name: "", display_name: "", description: "", enabled: 1 },
        false
      ).then(function(row) {
    ...
    // Cell edited — fire individual edit_strategy action
